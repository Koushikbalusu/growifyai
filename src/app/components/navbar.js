    ...
    <nav className="navbar">
      ...
      <div className="nav-links" data-active={activeIndex}>
        ...
        <Link
          href="/workshops"
          className={
            pathname === "/workshops" ? "active-link" : "inactive-link"
          }
        >
          Workshops
        </Link>
        <Link
          ...
          className={
            pathname === "/learningresources" ? "active-link" : "inactive-link"
          }
        >
          Learning Resources
        </Link>
        <Link
          href="/explorehackatons"
          className={
            pathname === "/explorehackatons" ? "active-link" : "inactive-link"
          }
        >
          Explore Hackathons
        </Link>
